...
const refForwardedReactZmage = React.forwardRef<HTMLImageElement, BaseType>(
    function ReactZmage(props, ref) {
        return <ReactZmage {...props} forwardedRef={ref}/>
    }
) as ForwardedComponent

export default refForwardedReactZmage
