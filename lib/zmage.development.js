...
function (_React$PureComponent) {
  ...
  Image_createClass(Images, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_["Fragment"], null, show && external_react_default.a.createElement(Image_loading, {
        didInvalidate: didInvalidate,
        onReload: this.handleImageReload
      }), external_react_default.a.createElement("img", {
        key: "".concat(page, "-").concat(set[page].src),
        className: "".concat(Image_default.a.imageLayer).concat(zoom ? " ".concat(Image_default.a.zooming) : "").concat(didInvalidate ? " ".concat(Image_default.a.didInvalidate) : ""),
        style: {
