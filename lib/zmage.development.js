...
var _initialiseProps = function _initialiseProps() {
    ...
    this.updateImageStyle = function () {
        ...
        var position = void 0,
            size = void 0;
        if (show) {
            position = _this3.pagePosition();
            if (zoom) {
                size = _this3.originalSize();
                (0, _utils.addListenEventOf)('mousemove', _this3.handleMouseMove);
            } else {
                size = _this3.pageFitSize();
                (0, _utils.removeListenEventOf)('mousemove', _this3.handleMouseMove);
            }
        } else {
            position = _this3.coverPosition();
            size = _this3.coverSize();
            (0, _utils.removeListenEventOf)('mousemove', _this3.handleMouseMove);
        }
        _this3.setStyle(_extends({}, position, size));
    };
