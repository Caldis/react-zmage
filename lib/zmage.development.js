...
Wrapper.propTypes = {
    ...
    // 生命周期方法
    onZooming: _propTypes2.default.func,
    onSwitching: _propTypes2.default.func,
    onRotating: _propTypes2.default.func
    ...
    _createClass(ReactZmage, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                backdrop = _props.backdrop,
                onZooming = _props.onZooming,
                onSwitching = _props.onSwitching,
                onRotating = _props.onRotating,
                props = _objectWithoutProperties(_props, ['className', 'src', 'alt', 'style', 'controller', 'hotKey', 'zIndex', 'backdrop', 'onZooming', 'onSwitching', 'onRotating']);
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.browsing = function (e) {
        var _props2 = _this3.props,
            onClick = _props2.onClick,
            onBrowsing = _props2.onBrowsing;
    ...
    this.unBrowsing = function () {
        var onBrowsing = _this3.props.onBrowsing;
...
ReactZmage.propTypes = {
    ...
    // 生命周期方法
    onBrowsing: _propTypes2.default.func,
    onZooming: _propTypes2.default.func,
    onSwitching: _propTypes2.default.func,
    onRotating: _propTypes2.default.func
