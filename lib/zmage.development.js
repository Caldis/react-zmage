...
/***/ "./node_modules/css-loader/index.js?{\"modules\":true,\"importLoaders\":1,\"localIdentName\":\"[local]__[hash:base64:5]\"}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"plugins\":[null]}!./node_modules/less-loader/dist/cjs.js!./src/components/Background/index.less":
...
/***/ "./node_modules/css-loader/index.js?{\"modules\":true,\"importLoaders\":1,\"localIdentName\":\"[local]__[hash:base64:5]\"}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"plugins\":[null]}!./node_modules/less-loader/dist/cjs.js!./src/components/Control/index.less":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js?{\"modules\":true,\"importLoaders\":1,\"localIdentName\":\"[local]__[hash:base64:5]\"}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"plugins\":[null]}!./node_modules/less-loader/dist/cjs.js!./src/components/Image/index.less":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js?{\"modules\":true,\"importLoaders\":1,\"localIdentName\":\"[local]__[hash:base64:5]\"}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"plugins\":[null]}!./node_modules/less-loader/dist/cjs.js!./src/components/Position/index.less":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js?{\"modules\":true,\"importLoaders\":1,\"localIdentName\":\"[local]__[hash:base64:5]\"}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\"}!./node_modules/less-loader/dist/cjs.js!./src/components/Wrapper/index.less":
/***/ (function(module, exports, __webpack_require__) {
...
// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js?{\"modules\":true,\"importLoaders\":1,\"localIdentName\":\"[local]__[hash:base64:5]\"}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"plugins\":[null]}!./node_modules/less-loader/dist/cjs.js!./src/components/Background/index.less");
    ...
    _createClass(Control, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                _react.Fragment,
                null,
                !zoom && _react2.default.createElement('div', { className: _index2.default.zoomButton, style: this.zoomStyle(show), onClick: toggleZoom }),
                ...
                hasMultipleImage && !zoom && _react2.default.createElement(
                    'div',
                ...
                !zoom ? imageSet[page].alt && _react2.default.createElement(
                    'div',
...
// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js?{\"modules\":true,\"importLoaders\":1,\"localIdentName\":\"[local]__[hash:base64:5]\"}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"plugins\":[null]}!./node_modules/less-loader/dist/cjs.js!./src/components/Control/index.less");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
var Image = function (_React$Component) {
	...
	function Image(props) {
		...
		_this.getCoverScale = function () {
			var coverNodeRef = _this.props.coverNodeRef;

			var coverScale = { scale: 0 };
			if (coverNodeRef) {
		...
		_this.setToCoverScale = function () {
			var _this$props = _this.props,
			    coverNodeRef = _this$props.coverNodeRef,
			    remove = _this$props.remove;

			_this.resize.to({
				data: _this.getCoverScale(),
		...
		_this.getPageFitScale = function () {
			var coverNodeRef = _this.props.coverNodeRef;

			var fitScale = { scale: 1 };
			if (coverNodeRef) {
				fitScale = { scale: (0, _utils.calcFitScale)(coverNodeRef, IMAGE_MARGIN) };
			}
			return fitScale;
		};

		_this.setToPageFitScale = function () {
			var coverNodeRef = _this.props.coverNodeRef;

			_this.resize.to({ data: _this.getPageFitScale() });
			if (!coverNodeRef) {
				_this.refs.imageLayer.style.maxWidth = 'calc(100vw - ' + 2 * IMAGE_MARGIN + 'px)';
				_this.refs.imageLayer.style.maxHeight = 'calc(100vh - ' + 2 * IMAGE_MARGIN + 'px)';
			}
		};

		_this.getOriginalScale = function () {
			return { scale: 1 };
		};

		_this.setToOriginalScale = function () {
			var coverNodeRef = _this.props.coverNodeRef;

			_this.resize.to({ data: _this.getOriginalScale() });
			if (!coverNodeRef) {
				_this.refs.imageLayer.style.maxWidth = '';
				_this.refs.imageLayer.style.maxHeight = '';
			}
		};

		_this.handleResizeScale = function (curr) {
			if (_this.refs.imageLayer) {
				_this.refs.imageLayer.style.transform = 'translate(-50%, -50%) scale(' + curr.scale + ')';
			}
		};
	...
	_createClass(Image, [{
		...
		value: function componentWillMount() {
			...
			(0, _utils.addListenEventOf)('resize', this.setToPageFitScale);
		}
	}, {
		...
		value: function componentWillUnmount() {
			(0, _utils.removeListenEventOf)('resize', this.setToPageFitScale);
		}
...
// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js?{\"modules\":true,\"importLoaders\":1,\"localIdentName\":\"[local]__[hash:base64:5]\"}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"plugins\":[null]}!./node_modules/less-loader/dist/cjs.js!./src/components/Image/index.less");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
var Position = function (_React$Component) {
	...
	function Position(props) {
		...
		_this.handleMoveCenterPosition = function (curr) {
			...
			if (_this.refs.positionController) {
				_this.refs.positionController.style.visibility = 'visible';
				_this.refs.positionController.style.transform = 'translate3d(' + curr.x + 'px, ' + curr.y + 'px, 0)';
				if (!show) {
					var scrollChange = window.pageYOffset - _this.initialPageOffset;
					_this.refs.positionController.style.top = 'calc(50% - ' + scrollChange + 'px)';
				}
			}
		};
...
// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js?{\"modules\":true,\"importLoaders\":1,\"localIdentName\":\"[local]__[hash:base64:5]\"}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"plugins\":[null]}!./node_modules/less-loader/dist/cjs.js!./src/components/Position/index.less");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
var Wrapper = function (_React$Component) {
    ...
    function Wrapper(props) {
        ...
        _this.mountSelf = function () {
            ...
            _this.setState({ show: true }, function () {
                ...
                (0, _utils.addListenEventOf)('wheel', _this.handleWheelScroll);
            });
        };
    ...
    _createClass(Wrapper, [{
        ...
        value: function componentWillUnmount() {
            ...
            (0, _utils.removeListenEventOf)('wheel', this.handleWheelScroll);
        }
...
// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js?{\"modules\":true,\"importLoaders\":1,\"localIdentName\":\"[local]__[hash:base64:5]\"}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\"}!./node_modules/less-loader/dist/cjs.js!./src/components/Wrapper/index.less");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
            ...
            return _react2.default.createElement('img', _extends({
                ...
                onClick: function onClick() {
                    ...
                    (0, _Wrapper.showImage)({
                        ...
                        imageSet: imageSet && imageSet.constructor === Array ? imageSet : [{
                            src: hiResSrc || src,
                            alt: alt,
                            text: text
                        }]
...
var _initialiseProps = function _initialiseProps() {
	...
	this._loop = function () {
		...
		for (var _key2 in _this.current) {
			if (Math.abs(_this.pool[_key2] - _this.current[_key2]) > 0.0005) {
				needLoop = true;
			}
		}
