...
var icon_ArrowLeftIcon =
/*#__PURE__*/
function (_React$PureComponent3) {
  icon_inherits(ArrowLeftIcon, _React$PureComponent3);

  function ArrowLeftIcon() {
    icon_classCallCheck(this, ArrowLeftIcon);

    return icon_possibleConstructorReturn(this, icon_getPrototypeOf(ArrowLeftIcon).apply(this, arguments));
  }

  icon_createClass(ArrowLeftIcon, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement("svg", {
        version: "1.1",
        ...
        d: "M663.4,928.8L269,534.4c-11.9-11.9-11.9-31.8,0-43.7L663.4,95.3c11.9-11.9,31.8-11.9,43.7,0c11.9,11.9,11.9,31.8,0,43.7L334.5,512L707,884.6c11.9,11.9,11.9,31.8,0,43.7C695.1,940.7,675.3,940.7,663.4,928.8z"
      }));
    }
  }]);
...
var icon_ArrowRightIcon =
/*#__PURE__*/
function (_React$PureComponent4) {
  icon_inherits(ArrowRightIcon, _React$PureComponent4);

  function ArrowRightIcon() {
    icon_classCallCheck(this, ArrowRightIcon);

    return icon_possibleConstructorReturn(this, icon_getPrototypeOf(ArrowRightIcon).apply(this, arguments));
  }

  icon_createClass(ArrowRightIcon, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement("svg", {
        version: "1.1",
        ...
        d: "M269,928.3c-11.9-11.9-11.9-31.8,0-43.7L641.5,512L269,139c-11.9-11.9-11.9-31.8,0-43.7c11.9-11.9,31.8-11.9,43.7,0L707,490.7c11.9,11.9,11.9,31.8,0,43.7L312.6,928.8C300.7,940.7,280.9,940.7,269,928.3z"
      }));
    }
  }]);
...
function (_React$PureComponent5) {
  icon_inherits(CloseIcon, _React$PureComponent5);
...
function (_React$PureComponent) {
  ...
  Control_createClass(Control, [{
    ...
    value: function render() {
      ...
      }, external_react_default.a.createElement(icon_CloseIcon, null))), Array.isArray(set) && set.length > 1 && controller.flip && external_react_default.a.createElement(external_react_["Fragment"], null, external_react_default.a.createElement("div", {
        className: this.withShow(Control_default.a.flipLeft),
        style: {
          backgroundColor: backdrop
        },
        onClick: toPrevPage
      }, external_react_default.a.createElement(icon_ArrowLeftIcon, null)), external_react_default.a.createElement("div", {
        className: this.withShow(Control_default.a.flipRight),
        style: {
          backgroundColor: backdrop
        },
        onClick: toNextPage
      }, external_react_default.a.createElement(icon_ArrowRightIcon, null))), Array.isArray(set) && set.length > 1 && controller.pagination && external_react_default.a.createElement("div", {
