...
function (_React$PureComponent) {
  ...
  function Images(props) {
    ...
    Image_defineProperty(Image_assertThisInitialized(Image_assertThisInitialized(_this)), "handleImageLoading", function (callback) {
      _this.setState({
        isFetching: true,
        didInvalidate: false
      }, callback);
    ...
    Image_defineProperty(Image_assertThisInitialized(Image_assertThisInitialized(_this)), "handleImageLoad", function () {
      _this.handleImageLoading(_this.updateCurrentImageStyle);
    });
