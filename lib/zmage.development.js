...
var Control = function (_React$PureComponent) {
    ...
    _createClass(Control, [{
        ...
        value: function render() {
            ...
            var motionStyle = this.state.motionStyle;

            var hasMultipleImage = set.length > 1;
            return _react2.default.createElement(
                _reactMotion.Motion,
                { style: {
                        over: (0, _reactMotion.spring)(motionStyle.over),
                        rotate: (0, _reactMotion.spring)(motionStyle.rotate),
                        opacity: (0, _reactMotion.spring)(motionStyle.opacity)
                    } },
                function (_ref) {
                    var over = _ref.over,
                        rotate = _ref.rotate,
...
var Image = function (_React$PureComponent) {
    ...
    function Image(props) {
        ...
        _this.state = {
            // 样式
            defaultStyle: { scale: scale },
            currentStyle: { scale: scale }
        };
        return _this;
    }
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _reactMotion.Motion,
                    {
                        ...
                        style: { scale: (0, _reactMotion.spring)(currentStyle.scale, _default.defProp.springOption) },
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.pageFitSize = function () {
        ...
        var fitScale = (0, _utils.calcFitScale)(cover, margin);
        return {
            scale: fitScale
        };
    };
...
var Position = function (_React$PureComponent) {
    _inherits(Position, _React$PureComponent);
    ...
    _createClass(Position, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: _index2.default.positionLayer, style: { width: (0, _utils.windowWidth)(), height: (0, _utils.windowHeight)() } },
                _react2.default.createElement(
                    _reactMotion.Motion,
                    {
                        defaultStyle: defaultStyle,
                        style: {
                            x: (0, _reactMotion.spring)(currentStyle.x, _default.defProp.springOption),
                            y: (0, _reactMotion.spring)(currentStyle.y, _default.defProp.springOption)
                        }
                    },
                    function (_ref) {
                        var x = _ref.x,
                        ...
                        return _react2.default.createElement(
                            ...
                            { style: {
                                    ...
                                    top: show ? 'initial' : (0, _utils.windowHeight)() / 2 - (window.pageYOffset - _this2.initialPageOffset)
                                } },
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.coverCenterPosition = function () {
        ...
        return page === 0 ? {
            x: -(0, _utils.windowWidth)() / 2 + coverRect.left + coverRect.width / 2,
            y: -(0, _utils.windowHeight)() / 2 + coverRect.top + coverRect.height / 2
        } : {
            x: 0,
    ...
    this.mouseContrastPosition = function (e) {
        ...
        var cw = (0, _utils.windowWidth)();
        var ch = (0, _utils.windowHeight)();
        var mouseX = e.clientX;
        var mouseY = e.clientY;
        // 计算偏移量
        var imgPosX = nw > cw ? (nw - cw) / 2 + margin - mr.x * (mouseX / cw) : 0;
        var imgPosY = nh > ch ? (nh - ch) / 2 + margin - mr.y * (mouseY / ch) : 0;
        // 返回位置
        return {
            x: imgPosX,
            y: imgPosY
    ...
    this.updateZoomMovePositionRange = function () {
        ...
        image.onload = function () {
            ...
            _this3.setState({
                ...
                moveRange: !zoom ? {
                    x: naturalWidth - (0, _utils.windowWidth)() + 2 * margin,
                    y: naturalHeight - (0, _utils.windowHeight)() + 2 * margin
                } : null
            });
        };
    };
            ...
            return _react2.default.createElement(
                ...
                browsing && _react2.default.createElement(
                    ...
                    _react2.default.createElement(_Wrapper2.default, {
                        ...
                        remove: function remove() {
                            return _this2.setState({ browsing: false });
                        }
                    })
                )
            );
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.buildImageSet = function (props) {
        var set = props.set,
            src = props.src,
    ...
    this.handleToggleBrowsing = function () {
        var onClick = _this3.props.onClick;

        onClick && onClick.constructor === Function && onClick();
        _this3.setState({ browsing: !_this3.state.browsing });
    };
};
...
var calcFitScale = exports.calcFitScale = function calcFitScale(nodeRef, margin) {
  var scaleX = clientWidth() / (nodeRef.naturalWidth + 2 * margin);
  var scaleY = clientHeight() / (nodeRef.naturalHeight + 2 * margin);
