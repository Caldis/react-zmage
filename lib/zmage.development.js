  ...
  Zmage_callee_createClass(ReactZmageCallee, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          restProps = _objectWithoutProperties(_this$props, ["className", "style", "onClick", "coverRef", "src", "alt", "txt", "set", "defaultPage", "preset", "controller", "hotKey", "animate", "zIndex", "backdrop", "radius", "edge", "loop", "onBrowsing", "onZooming", "onSwitching", "onRotating", "browsing"]);
  ...
  Zmage_createClass(ReactZmage, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          onRotating = _this$props.onRotating,
          controlledBrowsing = _this$props.browsing,
          restProps = Zmage_objectWithoutProperties(_this$props, ["className", "style", "onClick", "forwardedRef", "src", "alt", "txt", "set", "defaultPage", "preset", "controller", "hotKey", "animate", "coverVisible", "backdrop", "zIndex", "radius", "edge", "loop", "onBrowsing", "onZooming", "onSwitching", "onRotating", "browsing"]);
