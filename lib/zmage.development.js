...
function (_React$PureComponent) {
  ...
  loading_createClass(Loading, [{
    ...
    value: function render() {
      ...
      }), invalidate && external_react_default.a.createElement("button", {
...
function (_React$PureComponent) {
  ...
  Image_createClass(Images, [{
    ...
    value: function render() {
      ...
      var imageStyle = Image_objectSpread({
        ...
        clipPath: currentStyle.borderRadius ? "inset(0% 0% 0% 0% round ".concat(currentStyle.borderRadius / currentStyle.scale, "px)") : "inset(0% 0% 0% 0% round 0)",
