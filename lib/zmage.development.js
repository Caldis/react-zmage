...
exports.default = function (_ref) {
  ...
  return _react2.default.createElement(
    _reactMotion.Motion,
    { defaultStyle: { opacity: 0 }, style: (0, _utils.springlization)({ opacity: show ? 1 : 0 }) },
    function (_ref2) {
...
var Images = function (_React$PureComponent) {
    ...
    function Images(props) {
        ...
        var _this$coverPosition = _this.coverPosition(),
            x = _this$coverPosition.x,
            y = _this$coverPosition.y;
        // 初始封面尺寸
        ...
        _this.state = {
            ...
            moveRange: null,
            // 样式
            defaultStyle: { x: x, y: y, scale: scale },
            currentStyle: { x: x, y: y, scale: scale }
        };
        return _this;
    }
    ...
    _createClass(Images, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            this.setStyle(_extends({}, position, size));
        }
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _reactMotion.Motion,
                    {
                        ...
                        style: (0, _utils.springlization)({ x: cs.x, y: cs.y, scale: cs.scale }),
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.updateZoomMovePositionRange = function () {
        ...
        image.onload = function () {
            ...
            _this3.setState({
                ...
                moveRange: !zoom ? {
                    x: naturalWidth - (0, _utils.scrollWidth)() + 2 * margin,
    ...
    this.handleMouseMove = function (e) {
        _this3.setStyle(_this3.mouseContrastPosition(e));
    };
    ...
    this.setStyle = function (style) {
        ...
        var _style$x = style.x,
            ...
            scale = _style$scale === undefined ? cs.scale : _style$scale;
