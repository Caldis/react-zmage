...
function (_React$PureComponent) {
  ...
  Zmage_createClass(ReactZmage, [{
    ...
    value: function render() {
      ...
      var stateBrowsing = this.state.browsing;
      ...
      , {
        browsing: this.isControlled ? controlledBrowsing : stateBrowsing // Internal
        ,
...
Zmage_ReactZmage.browsing = function (_ref) {
  var browsing = _ref.browsing,
      props = _objectWithoutProperties(_ref, ["browsing"]);
  ...
  external_react_dom_default.a.render(external_react_default.a.createElement(Zmage_ReactZmage, _extends({}, props, {
    ...
    onBrowsing: function onBrowsing(status) {
      if (!status) {
        try {
          setTimeout(function () {
  ...
  return function () {// Unmount target
  };
}; // 属性默认值
