...
var _initialiseProps = function _initialiseProps() {
    ...
    this.pageFitSize = function () {
        ...
        if (coverNodeRef) {
            fitScale = {
                scale: (0, _utils.calcFitScale)(coverNodeRef, margin),
                borderWidth: 0,
                borderRadius: 5
            };
        }
    ...
    this.handleMotionRest = function () {
        var _props3 = _this3.props,
            coverNodeRef = _props3.coverNodeRef,
    ...
    this.updateZoomMovePositionRange = function () {
        ...
        image.onload = function () {
            ...
            _this3.setState({
                ...
                moveRange: !zoom ? {
                    x: naturalWidth - (0, _utils.clientWidth)() + 2 * margin,
                    y: naturalHeight - (0, _utils.clientHeight)() + 2 * margin
                } : null
            });
        };
    };
