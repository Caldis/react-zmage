...
var defType = {
  ...
  unBrowsing: external_prop_types_default.a.func,
...
var defProp = {
  ...
  unBrowsing: function unBrowsing() {},
...
var defPropAuto = _objectSpread({}, defProp, env.isDesktop ? defPreset.desktop : defPreset.mobile);
...
var Image = __webpack_require__("./src/components/Image/Image.less");
...
function (_React$PureComponent) {
  ...
  function Images(props, context) {
    ...
    Image_defineProperty(Image_assertThisInitialized(Image_assertThisInitialized(_this)), "handleResize", function () {
  ...
  Image_createClass(Images, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var _this$props3 = this.props,
          currShow = _this$props3.show,
          currZoom = _this$props3.zoom,
          currRotate = _this$props3.rotate,
          currPage = _this$props3.page; // 状态改变时更新样式 (Page 导致的 src 变化的 update 交给图片自身的 onload 调用)
    ...
    value: function render() {
      ...
      var _this$context = this.context,
          ...
          zoom = _this$context.zoom,
          page = _this$context.page,
          pageIsCover = _this$context.pageIsCover;
...
Image_Images.contextType = Context;
...
function (_React$PureComponent) {
  ...
  function Browser(props) {
    ...
    Browser_defineProperty(Browser_assertThisInitialized(Browser_assertThisInitialized(_this)), "init", function () {
      var _this$props = _this.props,
    ...
    Browser_defineProperty(Browser_assertThisInitialized(Browser_assertThisInitialized(_this)), "unInit", function () {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          force = _ref.force;
    ...
    Browser_defineProperty(Browser_assertThisInitialized(Browser_assertThisInitialized(_this)), "handleKeyDown", function (e) {
      // 阻止默认事件
      e.preventDefault();
    ...
    Browser_defineProperty(Browser_assertThisInitialized(Browser_assertThisInitialized(_this)), "handleScroll", function () {
      _this.state.show && _this.props.outBrowsing();
    });

    Browser_defineProperty(Browser_assertThisInitialized(Browser_assertThisInitialized(_this)), "handleToPage", function (page) {
      var _this$props4 = _this.props,
          coverRef = _this$props4.coverRef,
          onSwitching = _this$props4.onSwitching;
      var set = _this.state.set;
    ...
    Browser_defineProperty(Browser_assertThisInitialized(Browser_assertThisInitialized(_this)), "handleSwitchPages", function (direction) {
    ...
    Browser_defineProperty(Browser_assertThisInitialized(Browser_assertThisInitialized(_this)), "handleToPrevPage", _this.handleSwitchPages("prev"));

    Browser_defineProperty(Browser_assertThisInitialized(Browser_assertThisInitialized(_this)), "handleToNextPage", _this.handleSwitchPages("next"));

    Browser_defineProperty(Browser_assertThisInitialized(Browser_assertThisInitialized(_this)), "handleToggleZoom", function () {
    ...
    Browser_defineProperty(Browser_assertThisInitialized(Browser_assertThisInitialized(_this)), "handleToggleRotate", function (direction) {
  ...
  Browser_createClass(Browser, [{
    ...
    value: function render() {
      ...
      }, external_react_default.a.createElement(Background_Background_Background, statusValue), external_react_default.a.createElement(Control_Control_Control, statusValue), external_react_default.a.createElement(Image_Images, statusValue)));
    }
  }], [{
...
// CONCATENATED MODULE: ./src/Zmage.constant.js
// 来源类型
var SOURCE_TYPE = {
  'COMPONENT': 'COMPONENT',
  'COMMAND': 'COMMAND'
...
function (_React$PureComponent) {
  ...
  function ReactZmage(props) {
    ...
    Zmage_defineProperty(Zmage_assertThisInitialized(Zmage_assertThisInitialized(_this)), "inBrowsing", function () {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          force = _ref.force;

      var onBrowsing = _this.props.onBrowsing;

      if (_this.isControlled && !force) {
    ...
    Zmage_defineProperty(Zmage_assertThisInitialized(Zmage_assertThisInitialized(_this)), "outBrowsing", function () {
      var unBrowsing = _this.props.unBrowsing;
  ...
  Zmage_createClass(ReactZmage, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          unBrowsing = _this$props.unBrowsing,
          onZooming = _this$props.onZooming,
          onSwitching = _this$props.onSwitching,
          onRotating = _this$props.onRotating,
          controlledBrowsing = _this$props.browsing,
          restProps = _objectWithoutProperties(_this$props, ["className", "style", "onClick", "src", "alt", "txt", "set", "defaultPage", "preset", "controller", "hotKey", "zIndex", "backdrop", "radius", "edge", "onBrowsing", "unBrowsing", "onZooming", "onSwitching", "onRotating", "browsing"]);

      var browsing = this.state.browsing;
      var defPropWithEnv = preset.toString() === "desktop" ? defPropDesktop : preset.toString() === "mobile" ? defPropMobile : defPropAuto;
      ...
      , {
        ...
        ,
        controller: Zmage_objectSpread({}, defPropWithEnv.controller, controller),
        hotKey: Zmage_objectSpread({}, defPropWithEnv.hotKey, hotKey) // Styles
        ,
        zIndex: zIndex,
        backdrop: backdrop,
        radius: radius,
  ...
  return ReactZmage;
}(external_react_default.a.PureComponent); // 命令式



var commandTarget, commandContainer;

Zmage_ReactZmage.browsing = function (_ref2) {
  var browsing = _ref2.browsing,
      props = _objectWithoutProperties(_ref2, ["browsing"]);

  // Init env
  commandTarget = document.body;
  commandContainer = document.createElement('div');
  commandContainer.id = 'zmagePortal';
  commandTarget.appendChild(commandContainer); // Mount target

  external_react_dom_default.a.render(external_react_default.a.createElement(Zmage_ReactZmage, _extends({}, props, {
    ...
    unBrowsing: function unBrowsing() {
      ...
      try {
        setTimeout(function () {
          return commandTarget.removeChild(commandContainer);
        }, 350);
      } catch (e) {}
    }
  })), commandContainer);
