...
const resources = [
  ...
  ['Error recovery', '/developers/errors.md', 'How agents should recover from GitHub Pages HTML 404 responses and missing static endpoints.'],
  ['Rate limits', '/developers/rate-limits.md', 'Clarifies that no product API quota applies because react-zmage is a client-side package.'],
  ['Status', '/status.md', 'Static site and package status notes for agents.'],
  ['Status page', '/status', 'Human-readable status page for the static docs site and npm package surfaces.'],
  ['About', '/about', 'Project identity, repository, npm package, license, and package boundaries.'],
  ['Contact', '/contact', 'GitHub issue path for support, bugs, feature requests, and documentation problems.'],
  ['Privacy', '/privacy', 'Plain-language privacy notes for the package and documentation site.'],
  ...
  ['AGENTS.md', '/AGENTS.md', 'Repository instructions for coding agents working in react-zmage.'],
  ['.cursorrules', '/.cursorrules', 'Cursor-compatible pointer to the repository agent instructions.'],
