export const zhCN = {
  ...
  'gesture.desc': '跟随 preset 的手势配置。桌面预设在 zoom 态开启滚轮缩放;移动端预设开启拖拽翻页和拖拽退出。',
  ...
  'param.gesture.desc': '跟随 preset 的手势配置。桌面在 zoom 态开启 wheelZoom;移动端默认开启 swipe 和 dragExit。gesture=false 可全部关闭。',
  ...
  'docs.search.desc.propsGesture': '滚轮缩放、拖拽翻页和拖拽退出',
