...
export const ja: I18nDict = {
  ...
  'docs.section.migration.bullet1': "preset: 'auto' は廃止されました ── 代わりに 'desktop' または 'mobile' を使ってください。",
  'docs.section.migration.bullet2': 'コンポーネントは forwardRef exotic です。new Zmage() しないでください。',
  'docs.section.migration.bullet3': 'SSR エントリを参照している場合は react-zmage/ssr に切り替えてください。',
