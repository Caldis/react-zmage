...
export const es: I18nDict = {
  ...
  'docs.section.migration.bullet1': "preset: 'auto' está obsoleto: usa 'desktop' o 'mobile'.",
  'docs.section.migration.bullet2': 'El componente es un forwardRef exotic; no uses new Zmage().',
  'docs.section.migration.bullet3': 'Si importas la entrada SSR, cambia a react-zmage/ssr.',
