...
export const en: I18nDict = {
  ...
  'hero.cta.playground': 'Try Origin Expand',
  ...
  'controller.layout.desc': 'Adjust toolbar, pagination, and caption overlay positions. Numbers are px, strings are passed through as CSS lengths; layout.mobile overrides the mobile preset.',
  'controller.layout.paginationBottom.desc': 'Bottom inset for pagination dots, useful when caption or custom page UI needs extra space.',
  'controller.layout.captionBottom.desc': 'Bottom inset for the caption, useful when it should sit above pagination or bottom controls.',
  ...
  'docs.section.props.controller.layoutIntro': 'layout only offsets controller, pagination, and caption overlays; it does not participate in first-frame or zoom geometry. Numbers are px, strings are CSS lengths, and layout.mobile overrides the base layout on mobile.',
